...
//        
        let navigationController = UINavigationController(rootViewController: CompositionalLayoutViewController(viewModel: ContactListViewModel(repository: ContactRepositoryImpl(contactService: ContactServiceImpl()))))
